...
func (_m *Repository) GetById(ctx context.Context, id uint) (descriptions.Domain, error) {
	ret := _m.Called(ctx, id)
...
func (_m *Repository) GetListDescription(ctx context.Context, search string) ([]descriptions.Domain, error) {
