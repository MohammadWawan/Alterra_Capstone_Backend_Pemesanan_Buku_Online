...
func (_m *Usecase) GetById(ctx context.Context, id uint) (categories.Domain, error) {
	ret := _m.Called(ctx, id)
...
func (_m *Usecase) GetListCategory(ctx context.Context, search string) ([]categories.Domain, error) {
...
func (_m *Usecase) InsertCategory(ctx context.Context, domain categories.Domain) (categories.Domain, error) {
...
func (_m *Usecase) Update(ctx context.Context, domain categories.Domain, id uint) (categories.Domain, error) {
