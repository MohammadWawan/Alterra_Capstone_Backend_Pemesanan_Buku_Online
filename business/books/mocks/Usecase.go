...
func (_m *Usecase) GetById(ctx context.Context, id uint) (books.Domain, error) {
	ret := _m.Called(ctx, id)
...
func (_m *Usecase) GetListBook(ctx context.Context, search string) ([]books.Domain, error) {
...
func (_m *Usecase) InsertBook(ctx context.Context, domain books.Domain) (books.Domain, error) {
...
func (_m *Usecase) Update(ctx context.Context, domain books.Domain, id uint) (books.Domain, error) {
